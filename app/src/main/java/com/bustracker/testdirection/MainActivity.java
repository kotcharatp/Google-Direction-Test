...
public class MainActivity extends FragmentActivity implements LocationListener {
    ...
    //Abstract class needed when implements LocationListener
    @Override
    ...
    private void setUpMapIfNeeded() {
        ...
        if (mGoogleMap == null) {
            ...
            if (mGoogleMap != null) {
                ...
                mGoogleMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(13.791393, 100.349620), 13.0f));
            }
        }
    }
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.bustracker.testdirection/http/host/path")
        );
